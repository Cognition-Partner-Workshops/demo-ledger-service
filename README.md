...
- Holiday calendars currently cover 1 Jan-31 Dec 2026; settlement calculations
  whose trade date or settlement date falls outside that window raise
  `CalendarCoverageError` rather than silently treating the day as open.
